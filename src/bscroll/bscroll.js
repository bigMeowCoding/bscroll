...
export class BScroll extends EventEmitter {
    constructor(el, options) {
        ...
        this.options.useTransition =
            this.options.useTransition && hasTransition;
    ...
    refresh() {
        ...
        this.scrollerWidth =
            parseInt(this.scroller.style.width) || this.scroller.clientWidth;
        this.scrollerHeight =
            parseInt(this.scroller.style.height) || this.scroller.clientHeight;
        if (this.options.wheel) {
    ...
    _translate(x, y) {
        ...
        if (this.options.wheel && !isBadAndroid) {
            for (let i = 0; i < this.itemLen; i++) {
                ...
                this.items[i].style[style.transform] =
                    "rotateX(" + deg + "deg)";
            }
        }
